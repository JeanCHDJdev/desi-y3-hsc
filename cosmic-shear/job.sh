...
command="cosmosis --mpi /global/cfs/projectdirs/desi/users/jchdj/software/cosmosis-standard-library/examples/hsc-y3-shear.ini"
srun -n 512 $command

# cosmosis /global/cfs/projectdirs/desi/users/jchdj/software/cosmosis-standard-library/examples/hsc-y3-shear.ini